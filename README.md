...
- [x] 1. The `index.html` file has a form with a search input. When the form is
...
- [x] 2. Using the results of the search, display information about the users to the
   page. (You might include showing their username, avatar and a link to their
   profile.)
- [x] 3. Clicking on one of these users should send a request to the
